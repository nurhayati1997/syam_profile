...
<!-- Mirrored from themeon.net/nifty/v3.0.0/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Dec 2021 05:25:50 GMT -->
<head>
    <meta name="generator" content="Hugo 0.87.0" />
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, shrink-to-fit=no">
    <title>Web Profile | SYAMRABU</title>
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <a href="index.html" class="brand-img stretched-link">
                            <img src="assets/img/logo.png" alt="Nifty Logo" class="Nifty logo">
                        </a>

                        <!-- Brand title -->
                        <div class="brand-title">Web Profile</div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom p-3">
                                    <div class="flex-shrink-0">
                                        <img class="img-sm rounded-circle" src="assets/img/profile-photos/logo.png" alt="Profile Picture" loading="lazy">
                                    </div>
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="mb-0">IT SYAMRABU</h5>
                                        <span class="text-muted fst-italic">rsudsyamrabu2021@gmail.com</span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <div class="list-group list-group-borderless mb-3">
                                            <div class="list-group-item text-center border-bottom mb-3">
                                                <p class="display-2 text-warning">17</p>
                                                <p class="h6 mb-0"><i class="demo-pli-basket-coins fs-4"></i> New orders</p>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="list-group list-group-borderless h-100 py-3">
                                            ...
                                            <a href="<?= base_url("login/logout") ?>" class="list-group-item list-group-item-action">
            ...
            <div class="mainnav__inner">
                ...
                <div class="mainnav__top-content scrollable-content pb-5">
                    ...
                    <div class="mainnav__profile mt-3">
                        ...
                        <div class="mininav-toggle text-center py-2">
                            <img class="mainnav__avatar img-md rounded-circle" src="assets/img/profile-photos/logo.png" alt="Profile Picture">
                        </div>
                            ...
                            <div class="d-grid">
                                ...
                                <button class="d-block btn shadow-none p-2" data-bs-toggle="collapse" data-bs-target="#usernav" aria-expanded="false" aria-controls="usernav">
                                    <span class="dropdown-toggle d-flex justify-content-center align-items-center">
                                        <h6 class="mb-0 me-2">IT SYAMRABU</h6>
                                    </span>
                                ...
                                <div id="usernav" class="nav flex-column collapse">
                                    <!-- <a href="#" class="nav-link d-flex justify-content-between align-items-center">
                                        <span><i class="demo-pli-mail fs-5 me-3"></i> Messages</span>
                                        <span class="badge bg-danger rounded-pill">14</span>
                                    </a>
                                    <a href="#" class="nav-link">
                                        <i class="demo-pli-male fs-5 me-3"></i> Profile
                                    </a>
                                    <a href="#" class="nav-link">
                                        <i class="demo-pli-gear fs-5 me-3"></i> Settings
                                    </a>
                                    <a href="#" class="nav-link">
                                        <i class="demo-pli-computer-secure fs-5 me-3"></i> Lock screen
                                    </a> -->
                    ...
                    <!-- Statistik Category -->
                    <h6 class="mainnav__caption mt-5 px-3 fw-bold">Statistik</h6>
                    <ul class="mainnav__menu nav flex-column">

                         <!-- Regular menu link -->
                        <li class="nav-item">
                            <a href="<?= base_url('dashboard') ?>" class="nav-link mininav-toggle"><i class="demo-pli-home fs-5 me-2"></i>

                                <span class="nav-label mininav-content">Dashboard</span>
                            </a>
                        </li>
                        <!-- END : Regular menu link -->

                    </ul>
                    <!-- END : statistik Category -->

                    <!-- menu Category -->
                    <h6 class="mainnav__caption mt-5 px-3 fw-bold">Menu</h6>
                    <ul class="mainnav__menu nav flex-column">
                        ...
                        <li class="nav-item has-sub">
                            ...
                            <a href="#" class="mininav-toggle nav-link collapsed"><i class="demo-pli-boot-2 fs-5 me-2"></i>
                                <span class="nav-label">Jenis Layanan</span>
                            </a>

                            <!-- Ui Elements submenu list -->
                            <ul class="mininav-content nav collapse">
                                <li class="nav-item">
                                    <a href="ui-elements/buttons/index.html" class="nav-link">Unggulan</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <!-- pengaduan Category -->
                    <h6 class="mainnav__caption mt-5 px-3 fw-bold">Pengaduan</h6>
                    <ul class="mainnav__menu nav flex-column">
                    ...
                    <!-- END : pengaduan Category -->

                     <!-- riwayat Category -->
                     <h6 class="mainnav__caption mt-5 px-3 fw-bold">Report</h6>
                    <ul class="mainnav__menu nav flex-column">
                ...
                <div class="mainnav__bottom-content border-top pb-2">
                    <ul id="mainnav" class="mainnav__menu nav flex-column">
                        <li class="nav-item">
                            <a href="<?= base_url("login/logout") ?>" class="nav-link mininav-toggle collapsed" aria-expanded="false">
                    ...
                    <nav class="px-3">
                        <div class="nav nav-callout nav-fill flex-nowrap" id="nav-tab" role="tablist">
                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#nav-chat" type="button" role="tab" aria-controls="nav-chat" aria-selected="true">
                                <i class="d-block demo-pli-speech-bubble-5 fs-4 mb-2"></i>
                                <small>Chat</small>
                            </button>
                            ...
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-reports" type="button" role="tab" aria-controls="nav-reports" aria-selected="false">
                                <i class="d-block demo-pli-information fs-4 mb-2"></i>
                                <small>Reports</small>
                            </button>
                            ...
                            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#nav-settings" type="button" role="tab" aria-controls="nav-settings" aria-selected="false">
                                <i class="d-block demo-pli-wrench fs-4 mb-2"></i>
...
<!-- Mirrored from themeon.net/nifty/v3.0.0/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Dec 2021 05:26:24 GMT -->
</html>