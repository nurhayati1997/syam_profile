        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap pt-3 pb-4">
                    <h1 class="page-title mb-2 mt-4">Informasi Berita</h1>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="_dm-collapsedByDefault" class="collapse">
                                            <div class="card-body">
                                                <form class="row g-3">
                                                    <div class="col-md-6">
                                                        <label for="_dm-inputNama_k" class="form-label">Tgl</label>
                                                        <input id="_dm-inputNama_k" type="date" class="form-control">
                                                    </div>

                                                    <div class="col-md-6">
                                                        <label for="_dm-inputNama_k" class="form-label">Judul Berita</label>
                            ...
                            <div class="table-responsove">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>13/12/2021</td>
                                            <td>Perawatan Pasca Operasi Hernia</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
