        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap pt-3 pb-4">
                    <h1 class="page-title mb-2 mt-4">Informasi Dokter</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header toolbar">
                                            <div class="toolbar-start">
                                                <h5 class="m-0">Tambah Data Informasi Dokter</h5>
                                            </div>
                                        ...
                                        <div id="_dm-collapsedByDefault" class="collapse">
                                            <div class="card-body">
                                                <form class="row g-3">
                                                     <div class="col-md-6">
                                                        <label for="inputState" class="form-label">Jenis Spesialis</label>
