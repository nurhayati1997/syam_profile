...
Pemulihan Operasi ERACS Lebih Cepat </h1>
</div>
</div>
</div>
...
<img width="800" height="490" src="wp-content/uploads/2019/08/berita02.jpg" class="img-fluid" alt="Hospital doctors examine patients so that" loading="lazy" srcset="wp-content/uploads/2019/08/berita02.jpg 800w, wp-content/uploads/2019/08/berita02.jpg 300w, wp-content/uploads/2019/08/berita02.jpg 768w" sizes="(max-width: 800px) 100vw, 800px" /> </div>
...
Desember 21, 2021</span><span class="meta-categories post-cat">
...
<p>Kebanyakan ibu hamil (bumil) cemas jika mengetahui harus sectio caesarean (SC) saat persalinan. Sebagian masyarakat masih beranggapan, pemulihan pasca melahirkan dengan cara operasi lebih lama.</p>
<p>Dokter Penanggung Jawab Anestesi RSUD Syamrabu Irwan Wibowo, Sp.An menjelaskan, banyak bumil takut saat mengatahui harus melahirkan dengan cara SC. Sebab, pemulihannya dianggap lebih lama daripada melahirkan secara normal.</p>
<p>Salah satu metode tindakan SC yaitu enhanced recovery after caesarean cection (ERACS). Metode itu dapat mempercepat pemulihan pasca melahirkan dibandingkan dengan Caesar biasa. ”Lebih nyaman karena minim rasa nyeri dan pemulihan lebih cepat,” terangnya kemarin (19/12).</p>
<p>Irawan menerangkan, ERACS merupakan pengembangan dari metode enhanced recovery after surgery (ERAS). Metode itu juga diterapkan dalam banyak operasi. Contohnya, operasi bedah digestif. Operasi dengan metode ERACS dapat mengurangi waktu perawatan pasien di rumah sakit dan mengurangi komplikasi setelah operasi.</p>
<p>”Karena itu, metode ERACS kemudian dikembangkan untuk tindakan operasi di bidang lain, salah satunya di bidang kebidanan,” jelasnya.</p>
<p>Bumil yang akan mendapat tindakan SC diharuskan tidak mengonsumsi apa pun. Tujuannya, meminimalkan terjadinya risiko komplikasi. Misalnya, mual dan muntah saat tindakan pembiusan. ”Biasanya, pasien tidak boleh makan selama delapan jam atau lebih,” imbuhnya.</p>
<p>Tetapi dalam SC ERACS, pasien akan diberi minuman yang mengandung gula sebagai sumber energi pada saat dua jam sebelum operasi. Pemberian minuman yang mengandung gula itu akan dipantau langsung oleh dokter spesialis anestesi.</p>
<p>Dokter anestesi berperan melakukan penilaian sebelumnya. Kemudian, memilih jenis anestesi yang paling sesuai dan mempercepat pemulihan pasien. Juga memastikan pasien tidak nyeri saat pembiusan pra dan pascaoperasi</p>
<p>Keuntungan yang bisa didapatkan dari metode ERACS yaitu pengalaman operasi tanpa sakit atau nyeri dan pemulihannya lebih cepat sehingga kembali lebih cepat melaksanakan aktivitasnya. ”Memungkinkan ibu dapat menyusui bayinya dengan posisi yang nyaman,” pungkasnya.</p>
