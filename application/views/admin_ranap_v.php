        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap pt-3 pb-4">
                    <h1 class="page-title mb-2 mt-4">Layanan Rawat Inap</h1>
                                    ...
                                    <div class="card">
                                        <div class="card-header toolbar">
                                            <div class="toolbar-start">
                                                <h5 class="m-0">Tambah Data Layanan Rawat Inap</h5>
                                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsove">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>IRNA A Penyakit Dalam</td>
                                            <td>ri_1.jpg</td>
                                        </tr>
                                        <tr>
                                            <td>IRNA B ATAS Bedah Wanita</td>
                                            <td>ri_2.jpg</td>
                                        </tr>
                                        <tr>
                                            <td>IRNA B BAWAH Bedah Pria</td>
                                            <td>ri_3.jpg</td>
                                        </tr>
                                        <tr>
                                            <td>IRNA B Kelas 1 </td>
                                            <td>ri_4.jpg</td>
                                        </tr>
                                        <!-- <tr>
                                            <td>Bed Tambahan</td>
