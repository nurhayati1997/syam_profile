		...
		<div class="page_banner_content  overlay" style="background-image: url(wp-content/uploads/2019/09/about-breadcrumb-bg.png);; --banner-overlay-color: rgba(28, 186, 159, 0.68); --banner-breadcumb-color: rgba(28, 186, 159, 1)">
			<div class="container d-lg-flex justify-content-between">
				...
				<ul class="medizco_breadcrumblist d-inline-flex flex-wrap flex-lg-nowrap align-items-center">
					...
					<li><a href="https://wp.xpeedstudio.com/medizco">Informasi </a></li>
																						...
																						<div class="row">
																							<div class="col-lg-6 elementkit-testimonial-col">
																								<div class="elementskit-commentor-content">
																									<div class="elementskit-client_logo">
																										<img width="38" height="38" src="wp-content/uploads/2019/08/quote-icon.png" class="attachment-full size-full" alt="" loading="lazy" />
																									</div>
																							...
																							<div class="col-lg-6 elementkit-testimonial-col">
																								<div class="elementskit-profile-image-card">
																									<img width="434" height="381" src="wp-content/uploads/2019/08/jantung.jpeg" class="attachment-full size-full" alt="" loading="lazy" sizes="(max-width: 434px) 100vw, 434px" />
																								</div>
																							</div>
																						</div>
																					</div>
													...
													<div class="elementor-widget-container">
														<div class="medizco_doctors medizco_doctors_filter" data-rtl="">
															<ul class="filter_nav d-flex flex-wrap justify-content-center">
																<li class="filter active" data-filter=".all-departments">Semua Kegiatan</li>
																<li class="filter " data-filter=".seminar">Seminar</li>
																<li class="filter " data-filter=".workshop">Workshop</li>
																<li class="filter " data-filter=".pelatihan">Pelatihan</li>
															</ul>

															<div class="filter_items row">
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments seminar">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Seminar 1</h3>
																		</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments seminar">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Seminar 2</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments seminar">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">seminar 3</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments workshop">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Workshop 1</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments workshop">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Workshop 2</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments workshop">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Workshop 3</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>

																</div>
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments pelatihan">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Pelatihan 1</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments pelatihan">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Pelatihan 2</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments pelatihan">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">Pelatihan 3</h3>
																		</div>
																		<a href="" class="doctor_box_link"></a>
																	</div>
