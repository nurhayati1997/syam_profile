...
<ul class="medizco_breadcrumblist d-inline-flex flex-wrap flex-lg-nowrap align-items-center">
    ...
    <li class="seperator">-</li><li>Diklat</li></ul> </div>
</div>
</div>
...
<img width="434" height="381" src="wp-content/uploads/2019/08/jantung.jpeg" class="attachment-full size-full" alt="" loading="lazy"  sizes="(max-width: 434px) 100vw, 434px" /> </div>
</div>
</div>
</div>
</div>
...
<div class="filter_items row"><div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments seminar">
...
</div><div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments seminar">
<div class="doctor_box">
<div class="doctor_box_img">
<img width="255" height="255" src="wp-content/uploads/2019/08/s1.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" sizes="(max-width: 255px) 100vw, 255px" /> 
<ul class="doctor_box_social d-flex flex-column justify-content-end">
...
</div><div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments workshop">
<div class="doctor_box">
<div class="doctor_box_img">
...
</div><div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments pelatihan">
<div class="doctor_box">
<div class="doctor_box_img">
