...
<head>
	...
	<script type="text/javascript">
		window._wpemojiSettings = {
			...
			"svgExt": ".svg",
			"source": {
				"concatemoji": "https:\/\/wp.xpeedstudio.com\/medizco\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.8.2"
			}
		};
		! function(e, a, t) {
	...
	<link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/2306.json" />
...
<body class="home page-template page-template-template page-template-template-home page-template-templatetemplate-home-php page page-id-2 theme-medizco woocommerce-no-js sidebar-active elementor-default elementor-kit-4824 elementor-page elementor-page-2">
	<div class="medizco-preloder"><img src="wp-content/themes/medizco/assets/images/preloader/puff.svg" width="50" alt="preloader"></div>
												...
												<div class="elementor-widget-container">
													<div class="elementor-image">
														<a href="index.html">
															...
															<!-- logo besar -->
															<img src="wp-content/uploads/elementor/thumbs/new.png" title="logo" alt="logo" />
														</a>
													</div>
												</div>
											</div>
...
<li id="menu-item-174" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2 current_page_item menu-item-174 nav-item elementskit-mobile-builder-content active" data-vertical-menu=750px><a href="index.html" class=" dropdown-item active">Home Page 01</a> <li id="menu-item-1041" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1041 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="home-page-02/index.html" class=" dropdown-item">Home Page 02</a> <li id="menu-item-1154" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1154 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="home-page-03/index.html" class=" dropdown-item">Home Page 03</a> <li id="menu-item-4768" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4768 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="home-4/index.html" class=" dropdown-item">Home Page 04</a> <li id="menu-item-4759" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4759 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="home-5/index.html" class=" dropdown-item">Home Page 05</a> <li id="menu-item-4760" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4760 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="home-6/index.html" class=" dropdown-item">Home Page 06</a> <li id="menu-item-4851" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4851 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="covid-one/index.html" class=" dropdown-item">Covid-19 One</a> <li id="menu-item-4852" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4852 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="covid-two/index.html" class=" dropdown-item">Covid-19 Two</a> <li id="menu-item-2638" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2638 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="one-page-01/index.html" class=" dropdown-item">One Page 01</a> <li id="menu-item-2681" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2681 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="one-page-02/index.html" class=" dropdown-item">One Page 02</a> <li id="menu-item-2705" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2705 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px><a href="one-page-03/index.html" class=" dropdown-item">One Page 03</a></ul>
																...
																<li id="menu-item-2823" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-2823 nav-item elementskit-dropdown-has relative_position elementskit-dropdown-menu-default_width elementskit-mobile-builder-content" data-vertical-menu=750px>
																	...
																	<ul class="elementskit-dropdown elementskit-submenu-panel">
																		...
																		<li id="menu-item-2087" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2087 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px>
																			<a href="<?php echo site_url('Penunjang'); ?>" class=" dropdown-item">Layanan Penunjang</a>
																	</ul>
																</li>
																<!-- end pelayanan -->
																...
																<li id="menu-item-4841" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4841 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px>
																	<a href="<?php echo site_url('Pengaduan'); ?>" class="ekit-menu-nav-link">Pengaduan</a>
																</li>
																<!-- end pengaduan -->
																...
																<li id="menu-item-4841" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-4841 nav-item elementskit-mobile-builder-content" data-vertical-menu=750px>
																	...
																	<a href="<?php echo site_url('laporan'); ?>" class="ekit-menu-nav-link">Arsip</a>
																</li>
																<!-- end laporan -->
													...
													<div class="elementor-widget-container">
														<div class="medizco_doctors medizco_doctors_filter" data-rtl="">
															<ul class="filter_nav d-flex flex-wrap justify-content-center">
																...
																<li class="filter " data-filter=".obgyn">Obgyn</li>
																<li class="filter " data-filter=".gigi">Gigi</li>
																<li class="filter " data-filter=".bedah_saraf">Bedah Saraf</li>
																<li class="filter " data-filter=".tb">TB DOTS</li>
																<li class="filter " data-filter=".vct">VCT</li>
																<li class="filter " data-filter=".gcu">GCU (General Check Up</li>
																<li class="filter " data-filter=".jiwa">Jiwa</li>
																<li class="filter " data-filter=".d_saraf">Diagnostik Saraf</li>
															</ul>
															<!-- suryo -->
															<div class="filter_items row">
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments jantung">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Suryo.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Suryo.jpg 255w, wp-content/uploads/spesialis/dr.Suryo.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments jantung">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ayu.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ayu.jpg 255w, wp-content/uploads/spesialis/dr.Ayu.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments jantung">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.harold.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.harold.jpg 255w, wp-content/uploads/spesialis/dr.harold.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments orthopedi">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Agung.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Agung.jpg 255w, wp-content/uploads/spesialis/dr.Agung.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments orthopedi">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ida.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ida.jpg 255w, wp-content/uploads/spesialis/dr.Ida.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments bedah_umum">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Nurul.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Nurul.jpg 255w, wp-content/uploads/spesialis/dr.Nurul.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments bedah_umum">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Aga.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Aga.jpg 255w, wp-content/uploads/spesialis/dr.Aga.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments bedah_umum">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Yusfik.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Yusfik.jpg 255w, wp-content/uploads/spesialis/dr.Yusfik.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments anestesi">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Bernard.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Bernard.jpg 255w, wp-content/uploads/spesialis/dr.Bernard.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<!-- dr. rosida -->
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments dalam vct">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Rosida.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Rosida.jpg 255w, wp-content/uploads/spesialis/dr.Rosida.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			...
																			<p class="doctor_box_role">Dalam & VCT</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																</div>
																...
																<!-- dr. yasmita -->
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments dalam geriatri vct">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Yasmita.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Yasmita.jpg 255w, wp-content/uploads/spesialis/dr.Yasmita.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			...
																			<p class="doctor_box_role">Dalam, VCT & Geriatri</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments dalam geriatri">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.dokter.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.dokter.jpg 255w, wp-content/uploads/spesialis/dr.dokter.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments dalam geriatri vct">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ummah.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ummah.jpg 255w, wp-content/uploads/spesialis/dr.Ummah.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments saraf">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Fery.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Fery.jpg 255w, wp-content/uploads/spesialis/dr.Fery.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<!-- dr. zainal -->
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments saraf d_saraf">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.dokter.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.dokter.jpg 255w, wp-content/uploads/spesialis/dr.dokter.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments rehab">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Nuryatien.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Nuryatien.jpg 255w, wp-content/uploads/spesialis/dr.Nuryatien.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments uro">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ari.png" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ari.png 255w, wp-content/uploads/spesialis/dr.Ari.png" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments uro">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ido.png" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ido.png 255w, wp-content/uploads/spesialis/dr.Ido.png" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments anak">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Indah.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Indah.jpg 255w, wp-content/uploads/spesialis/dr.Indah.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments anak">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Shirley.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Shirley.jpg 255w, wp-content/uploads/spesialis/dr.Shirley.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments kulit">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Tewu.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Tewu.jpg 255w, wp-content/uploads/spesialis/dr.Tewu.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<!-- dr. andri -->
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments paru tb">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Andri.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Andri.jpg 255w, wp-content/uploads/spesialis/dr.Andri.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments tht">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ima.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ima.jpg 255w, wp-content/uploads/spesialis/dr.Ima.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments tht">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Yuliarini.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Yuliarini.jpg 255w, wp-content/uploads/spesialis/dr.Yuliarini.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<!-- dr. mul -->
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments obgyn">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Muljadi.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Muljadi.jpg 255w, wp-content/uploads/spesialis/dr.Muljadi.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">dr. H. Mulyadi Amanullah, Sp. OG</h3>
																			<p class="doctor_box_role">Obgyn</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments obgyn">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Ummu.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Ummu.jpg 255w, wp-content/uploads/spesialis/dr.Ummu.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">dr. Hj. Ummu Hanik, Sp. OG</h3>
																			<p class="doctor_box_role">Obgyn</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments obgyn">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Desak.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Desak.jpg 255w, wp-content/uploads/spesialis/dr.Desak.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">dr. Desak Ketut Ayu Aryani, Sp. OG</h3>
																			<p class="doctor_box_role">Obgyn</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments obgyn">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.dokter.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.dokter.jpg 255w, wp-content/uploads/spesialis/dr.Nur.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">dr. Nur Waqiah, Sp. OG, M. Kes</h3>
																			<p class="doctor_box_role">Obgyn</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gigi">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Metaria.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Metaria.jpg 255w, wp-content/uploads/spesialis/dr.Metaria.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">drg. Metaria S., Sp. Perio</h3>
																			<p class="doctor_box_role">Gigi</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gigi">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Fairuza.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Fairuza.jpg 255w, wp-content/uploads/spesialis/dr.Fairuza.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">drg. Fairuza Afada, Sp. KG</h3>
																			<p class="doctor_box_role">Gigi</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gigi">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">drg. Hamida Yusuf</h3>
																			<p class="doctor_box_role">Gigi</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gigi">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.soniya.png" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.soniya.png 255w, wp-content/uploads/spesialis/dr.soniya.png" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">drg. Soniya Mayasari</h3>
																			<p class="doctor_box_role">Gigi</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gigi">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">drg. Fakhma Zakki Ramadhani, Sp. Ort</h3>
																			<p class="doctor_box_role">Gigi</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gigi">
																	<div class="doctor_box">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">drg. Hery Supriadi, Sp. BM</h3>
																			<p class="doctor_box_role">Gigi</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments bedah_saraf jiwa">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.indra.png" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.indra.png 255w, wp-content/uploads/spesialis/dr.indra.png" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																...
																<!-- dr. yulia -->
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gcu">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.dokter.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.dokter.jpg 255w, wp-content/uploads/spesialis/dr.dokter.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">dr. Yulia Mayasin</h3>
																			<p class="doctor_box_role">GCU (General Check Up)</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments gcu">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="wp-content/uploads/spesialis/dr.Sri.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="wp-content/uploads/spesialis/dr.Sri.jpg 255w, wp-content/uploads/spesialis/dr.Sri.jpg" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
																			</ul>
																		</div>
																		<div class="doctor_box_icon">
																		...
																		<div class="doctor_box_content">
																			<h3 class="doctor_box_title">dr. Sri Wahyu Utami</h3>
																			<p class="doctor_box_role">GCU (General Check Up)</p>
																		</div>
																		<a class="doctor_box_link"></a>
																	</div>
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments pediatric">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																...
																<div class="filter_item mix col-lg-3 col-md-6 col-sm-12 all-departments polmonary">
																	<div class="doctor_box">
																		<div class="doctor_box_img">
																			<img width="255" height="255" src="../wp-content/uploads/2019/08/team-4.jpg" class="attachment-medium_large size-medium_large wp-post-image" alt="" loading="lazy" srcset="https://wp.xpeedstudio.com/medizco/wp-content/uploads/2019/08/team-4.jpg 255w, https://wp.xpeedstudio.com/medizco/wp-content/uploads/2019/08/team-4-150x150.jpg 150w" sizes="(max-width: 255px) 100vw, 255px" />
																			<ul class="doctor_box_social d-flex flex-column justify-content-end">
	...
	<script type='text/javascript' id='wc-add-to-cart-js-extra'>
		...
		var wc_add_to_cart_params = {
			"ajax_url": "\/medizco\/wp-admin\/admin-ajax.php",
			"wc_ajax_url": "\/medizco\/?wc-ajax=%%endpoint%%",
			"i18n_view_cart": "View cart",
			"cart_url": "https:\/\/wp.xpeedstudio.com\/medizco\/cart\/",
			"is_cart": "",
	...
	<script type='text/javascript' id='wc-cart-fragments-js-extra'>
		...
		var wc_cart_fragments_params = {
			"ajax_url": "\/medizco\/wp-admin\/admin-ajax.php",
			"wc_ajax_url": "\/medizco\/?wc-ajax=%%endpoint%%",
			"cart_hash_key": "wc_cart_hash_367055c54ecb3b278a5be15b43f5126f",
			"fragment_name": "wc_fragments_367055c54ecb3b278a5be15b43f5126f",
	...
	<script type='text/javascript' id='elementor-frontend-js-before'>
		var elementorFrontendConfig = {
			...
			"urls": {
				"assets": "https:\/\/wp.xpeedstudio.com\/medizco\/wp-content\/plugins\/elementor\/assets\/"
			},
			"settings": {
				"page": [],
				"editorPreferences": []
			...
			"post": {
				"id": 2306,
				"title": "Doctors%20%E2%80%93%20Medizco",
				"excerpt": "",
				"featuredImage": false
			}
		};
