...
<head>
	...
	<link rel="alternate" type="application/json" href="wp-json/wp/v2/pages/1152.json" />
																				...
																				<div class="ekit-wid-con">
																					<div class="profile-card elementor-animation- text-center ekit-team-style-default">
																						<div class="profile-header">
																							<img loading="lazy" width="270" height="270" src="wp-content/uploads/2019/09/ketepatan.png" class="attachment-medium size-medium" alt="" />
																						</div>
																		...
																		<div class="elementor-element elementor-element-1e2ef9a medizco_team_box_2 elementor-widget elementor-widget-elementskit-team" data-id="1e2ef9a" data-element_type="widget" data-widget_type="elementskit-team.default">
																			<div class="elementor-widget-container">
																				<div class="ekit-wid-con">
																					<div class="profile-card elementor-animation- text-center ekit-team-style-default">
																						<div class="profile-header">
																							<img loading="lazy" width="270" height="270" src="wp-content/uploads/2019/09/kelengkapan.png" class="attachment-medium size-medium" alt="" />
																						</div>
																						<!-- <div class="profile-body">
<div class="profile-icon">
<i aria-hidden="true" class="fasicon icon-doctor"></i> </div>
																		...
																		<div class="elementor-element elementor-element-1e2ef9a medizco_team_box_2 elementor-widget elementor-widget-elementskit-team" data-id="1e2ef9a" data-element_type="widget" data-widget_type="elementskit-team.default">
																			<div class="elementor-widget-container">
																				<div class="ekit-wid-con">
																					<div class="profile-card elementor-animation- text-center ekit-team-style-default">
																						<div class="profile-header">
																							<img loading="lazy" width="270" height="270" src="wp-content/uploads/2019/09/ketersediaan.png" class="attachment-medium size-medium" alt="" />
																						</div>
																						<!-- <div class="profile-body">
<div class="profile-icon">
<i aria-hidden="true" class="fasicon icon-doctor"></i> </div>
																		...
																		<div class="elementor-element elementor-element-1e2ef9a medizco_team_box_2 elementor-widget elementor-widget-elementskit-team" data-id="1e2ef9a" data-element_type="widget" data-widget_type="elementskit-team.default">
																			<div class="elementor-widget-container">
																				<div class="ekit-wid-con">
																					<div class="profile-card elementor-animation- text-center ekit-team-style-default">
																						<div class="profile-header">
																							<img loading="lazy" width="270" height="270" src="wp-content/uploads/2019/09/pelaksanaan.png" class="attachment-medium size-medium" alt="" />
																						</div>
																						<!-- <div class="profile-body">
<div class="profile-icon">
<i aria-hidden="true" class="fasicon icon-doctor"></i> </div>
																		...
																		<div class="elementor-element elementor-element-1e2ef9a medizco_team_box_2 elementor-widget elementor-widget-elementskit-team" data-id="1e2ef9a" data-element_type="widget" data-widget_type="elementskit-team.default">
																			<div class="elementor-widget-container">
																				<div class="ekit-wid-con">
																					<div class="profile-card elementor-animation- text-center ekit-team-style-default">
																						<div class="profile-header">
																							<img loading="lazy" width="270" height="270" src="wp-content/uploads/2019/09/lapor.png" class="attachment-medium size-medium" alt="" />
																						</div>
																						<!-- <div class="profile-body">
<div class="profile-icon">
<i aria-hidden="true" class="fasicon icon-doctor"></i> </div>
...
<p class="profile-designation">Therapist</p>
										...
										<div class="elementor-column-wrap elementor-element-populated">
											<div class="elementor-widget-wrap">
												<div class="elementor-element elementor-element-0868337 mx-auto mw-100 elementor-widget__width-initial elementor-invisible elementor-widget elementor-widget-heading" data-id="0868337" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;fadeInUp&quot;,&quot;_animation_delay&quot;:0}" data-widget_type="heading.default">
													<div class="elementor-widget-container">
														<h2 class="elementor-heading-title elementor-size-default">Kesehatan Anda Adalah Komitmen Kami</h2>
													</div>
												</div>
	...
	<style id='rs-plugin-settings-inline-css' type='text/css'>
		.banner_caption_text>.rs_splitted_lines,
		.banner_caption_text>.rs_splitted_lines>.rs_splitted_words,
		.banner_caption_text>.rs_splitted_lines>.rs_splitted_words>.rs_splitted_chars {
			text-decoration: inherit
		}

		.banner-btn>i[class^="fa-"] {
			margin-left: 5px;
			font-size: 20px;
			vertical-align: -2px
		}
	...
	<script type='text/javascript' id='elementor-frontend-js-before'>
		var elementorFrontendConfig = {
			...
			"post": {
				"id": 1152,
				"title": "Home%20Page%2003%20%E2%80%93%20Medizco",
				"excerpt": "",
				"featuredImage": false
			}
		};
