...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/crud/forms/controls/radio.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:37:24 GMT -->
<!-- Added by HTTrack -->
...
<head>
	...
	<meta charset="utf-8" />
	<title>SOAL</title>
	<meta name="description" content="Custom radio controls" />
...
<body id="kt_body" style="background-image: url(assets_login/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
									...
									<div class="card card-custom gutter-b example example-compact">
										...
										<div class="card-body">
											...
											<form class="form-group row">
												...
												<div class="col-lg-6">
													...
													<div class="radio-list">
														<label class="radio">
															...
															<span></span>A. Default</label>

														<label class="radio">
															<input type="radio" name="radios1" />
															<span></span>B. Checked</label>
														<label class="radio">
															<input type="radio" name="radios1" />
															<span></span>C. Default</label>

														<label class="radio">
															<input type="radio" name="radios1" />
															<span></span>D. Checked</label>
													</div>
												</div>
												<div class="col-lg-6">
													<br> <label>Soal No 2</label>
													<div class="radio-list">
														<label class="radio">
												...
												<div class="col-lg-6">
													<br> <label>Soal No 14</label>
													<div class="radio-list">
														<label class="radio">
															<input type="radio" name="radios14" />
															<span></span>A. Default</label>
												...
												<div class="col-lg-12">
													...
													<div class="text-center">
														<button type="button" onClick="tambah()" id="tombolTambah" class="btn btn-success my-2">SUBMIT</button>
													</div>
												</div>
				...
				<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a class="text-dark-75 text-hover-primary">IT RSUD SYAMRABU</a>
						</div>
						<!--end::Copyright-->
					</div>
					<!--end::Container-->
	...
	<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
		...
		<li class="nav-item mb-2" data-toggle="tooltip" title="Logout" data-placement="left">
			<a class="btn btn-sm btn-icon btn-bg-light btn-icon-warning btn-hover-warning" href="<?= base_url("login/logout") ?>">
...
<!-- Mirrored from preview.keenthemes.com/metronic/demo2/crud/forms/controls/radio.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jan 2022 06:37:25 GMT -->
